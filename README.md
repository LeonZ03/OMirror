...
- 投屏期间，无论键盘模式和熄屏偏好如何，手机未解锁时都保持实体屏幕亮起，方便输入密码；确认解锁后才按“仅熄手机屏幕”的设置执行。投屏会话使用 scrcpy 的保持活动功能，避免锁屏界面短时间自动熄灭。
- 已知限制：部分 OPPO/ColorOS 设备在投屏中关闭“仅熄手机屏幕”后，实体屏幕仍可能无法自动恢复；本次改动不宣称解决此兼容性问题，详见[调查记录](docs/screen-power-investigation.md)。
